...
<header class="w3-container w3-top w3-hide-large w3-red w3-xlarge w3-padding">
  ...
  <span>Sahara</span>
  <!--login-->
    <a class="w3-right w3-large" style="margin-top:10px;" href="..\logout.php">Logout</a><span class="w3-large w3-right w3-padding"><?php $_SESSION['loggedName']?></span>
</header>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:50px">
    <h1 class="w3-jumbo"><b>Vendor info</b></h1>
  ...
  <?php
    $sql='SELECT Vendor_Name,User_Name, Address, Phone_Number FROM vendor WHERE Vendor_ID= '.$_SESSION["loggedID"].'';
    if($result = mysqli_query($conn, $sql)){
      $row = mysqli_fetch_row($result);
      echo '<span style="margin-left:10px;"><b>Welcome</b>, '.$row[0].'</span>';
      ...
      <form  action="..\profileupdate.php" method="GET">
          ...
          Vendor name: <input class="w3-input" type="text" name="vendorname" value="'.$row[0].'"><br><br>
          User name: <input class="w3-input" type="text" name="username" value="'.$row[1].'"><br><br>
          Adress:  <input class="w3-input" type="text" name="address" value="'.$row[2].'"><br><br>
          Phone number: <input class="w3-input" type="tel" name="phonenumber" value="'.$row[3].'"><br><br>
  ...
  <span onclick="document.getElementById('Password-change-form').style.display='none'" class="w3-button w3-display-topright">&times;</span>
    ...
    <?php 
      ...
      $sql = 'SELECT Password FROM vendor Where Vendor_ID = '.$loggedId.'';
      if($result = mysqli_query($conn, $sql)){
        $row = mysqli_fetch_row($result); 
        $password = $row[0];       
      }
